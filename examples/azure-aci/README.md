...
> **PREVIEW** - The `argus-agent-azure-aci` module is not yet wired into the Argus dashboard's Deploy Agent UI. The module works end-to-end, but expect minor breaking changes before the v1.x stable line. Pin `?ref=v0.9.0` in your `source` to insulate yourself.
